 ...
 * File Name: main.c
 *
 * Description: This file contains the starting point of Bluetooth LE BMI270 sensing
 *              service application.
 *
...
/* This function initializes the required BLE ESS & BMI270 task */
...
int main(void)
{
    ...
    /* Start Sensor Task */
    rtos_result = xTaskCreate(sensor_task,
                              SENSOR_TASK_NAME,
                           ...
                           wiced_bt_management_evt_data_t *p_event_data)
{
    ...
    {
        printf("\nThis application implements a custom BMI270 Sensing\n" \
                "Service and sends BMI270 sensor data over BLE\n");
...
static void bt_app_init(void)
{
    ...
    rslt = sensor_task_init();
    if (CY_RSLT_SUCCESS != rslt)
    {
        printf("Error initializing sensor task\n");
        CY_ASSERT(0);
    }
